...
test('should have loading state', () => {
    renderWithMockProvider(<AnimalsPage />, { query: GET_ANIMALS_QUERY });
    expect(screen.getByText(/Loading.../i)).toBeInTheDocument();
});

test('should handle error state', async () => {
    renderWithMockProvider(<AnimalsPage />, { query: GET_ANIMALS_QUERY, error: new Error('Something went wrong') });
...
test('should load animals list', async () => {
    renderWithMockProvider(<AnimalsPage />, {
